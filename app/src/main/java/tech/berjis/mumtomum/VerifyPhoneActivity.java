...
public class VerifyPhoneActivity extends AppCompatActivity {
    ...
    private String mVerificationId, countryCode, country, country_code, code, name, symbol;
                ...
                .addOnCompleteListener(VerifyPhoneActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            dbRef.child("Users").child(UID).child("regs_phone").setValue(UPhone);
                            dbRef.child("Users").child(UID).child("image").setValue("https://google.com");
                            saveCurrency(UID);
