    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agreementToTerms.setText(Html.fromHtml(
                "<h1>TERMS OF USE</h1>" +
                        ...
                        "<p>If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof).</p><br />" +
                        ...
                        "<li>-  MPesa</li>" +
                        "</ul>" +
                        "<p>You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in Kenyan Shilings.</p>" +
                        ...
                        "GOVERNING LAW\n" +
                        " \n" +
                        "These terms shall be governed by and defined following the laws of Kenya. Berjis Technologies and yourself irrevocably consent that the courts of Kenya shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.\n" +
                        " \n" +
                        "\n" +
                        "DISPUTE RESOLUTION\n" +
                        "\n" +
                        "You agree to irrevocably submit all disputes related to Terms or the relationship established by this Agreement to the jurisdiction of the Kenya courts. Berjis Technologies shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Terms are entered into in the course of your trade or profession, the state of your principal place of business.\n" +
                        "\n" +
                        "\n" +
                        "CORRECTIONS\n" +
                        "\n" +
                        ...
                        "Ruai, Nairobi 00520\n" +
                        "Kenya\n" +
                        "Phone: +254 725 227513\n" +
                        "berjistechnologies@gmail.com\n"
        ));
    }
}
